 ...
 *******************************************************************************/
void DrawRectangleFill(int x1 , int x2 , int y1 , int y2 , int borderColour, int fillColour )
{
	int j;
	int h_length = x2-x1;
	int v_length = y2-y1;
 ...
 ** Draw Triangle
 *******************************************************************************/
void DrawTriangles(int x1, int y1, int x2, int y2, int x3, int y3, int borderColour){
